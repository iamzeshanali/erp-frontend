    ...
    this.route.paramMap.subscribe( params => {
      ...
      this.ApiService.getAPI(this.entityName).subscribe( data => {
        if(data.hasOwnProperty('error')){
          ...
          this.docNumber = "SP-"+this.invoiceNumber;
        }
        ...
        if (ROUTE_ID) {
           ...
           .subscribe((res) => {
            if(res.hasOwnProperty('success')){
              this.success = true;
              this.notificationService.success('Success', 'Shipment Updated.');
            }else{
          ...
          .subscribe((res) => {
            ...
            if(res.hasOwnProperty('success')){
              this.success = true;
              this.notificationService.success('Success', 'Shipment Added.');
              this.formData.reset({
                code: '',
                description: '',
                season: '',
    ...
    this.route.paramMap.subscribe( params => {
      ...
      if (ROUTE_ID) {
        ...
        .subscribe((res) => {
          if(res.hasOwnProperty('success')){
            this.success = true;
            this.router.navigate(['warehouse/shipments']);
          }
        });
      }
    });
