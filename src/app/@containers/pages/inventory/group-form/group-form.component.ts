    ...
    this.route.paramMap.subscribe( params => {
      ...
      this.ApiService.getAPI(this.entityName).subscribe( data => {
        if(data.hasOwnProperty('error')){
          ...
          this.docNumber = "G-"+this.invoiceNumber;
        }
        ...
        if (ROUTE_ID) {
           ...
           .subscribe((res) => {
            if(res.hasOwnProperty('success')){
              this.success = true;
              this.notificationService.success('Success', 'Group Updated.');
            }else{
          ...
          .subscribe((res) => {
            ...
            if(res.hasOwnProperty('success')){
              this.success = true;
              this.notificationService.success('Success', 'Group Added.');
              this.formData.reset({
                code: '',
                description: '',
                status: '',
    ...
    this.route.paramMap.subscribe( params => {
      ...
      if (ROUTE_ID) {
        ...
        .subscribe((res) => {
          if(res.hasOwnProperty('success')){
            this.success = true;
            this.router.navigate(['inventory/group/']);
          }
        });
      }
    });
