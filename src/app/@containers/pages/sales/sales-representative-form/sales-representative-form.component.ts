...
@Component({
  selector: 'app-sales-representative-form',
  templateUrl: './sales-representative-form.component.html',
  styleUrls: ['./sales-representative-form.component.scss']
})
export class SalesRepresentativeFormComponent implements OnInit {

 
  moduleName = "salesRepresentative";
    ...
    this.route.paramMap.subscribe( params => {
      ...
      this.ApiService.getAPI(this.entityName).subscribe( data => {
        if(data.hasOwnProperty('error')){
          ...
          this.docNumber = "SR-"+this.invoiceNumber;
        }
        ...
        if (ROUTE_ID) {
           ...
           .subscribe((res) => {
            if(res.hasOwnProperty('success')){
              this.success = true;
              this.notificationService.success('Success', 'SalesRepresentative Updated.');
            }else{
          ...
          .subscribe((res) => {
            ...
            if(res.hasOwnProperty('success')){
              this.success = true;
              this.notificationService.success('Success', 'SalesRepresentative Added.');
              this.formData.reset({
                status: '',
                name: '',
                country: '',
    ...
    this.route.paramMap.subscribe( params => {
      ...
      if (ROUTE_ID) {
        ...
        .subscribe((res) => {
          if(res.hasOwnProperty('success')){
            this.success = true;
            this.router.navigate(['sales/salesRepresentative']);
          }
        });
      }
    });
